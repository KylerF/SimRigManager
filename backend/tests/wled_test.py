...
class TestWled(unittest.TestCase):
    ...
    def test_correct_universes(self):
        ...
        self.assertEqual(
            self.wled.universes, 2,
            msg='Expected 2 universes for 171 pixels'
        )
        self.wled.stop()

        self.wled = Wled.connect('127.0.0.1', 1500)
        self.assertEqual(
            self.wled.universes, 9,
            msg='Expected 9 universes for 1500 pixels'
        )
        self.wled.stop()
    ...
    def test_update_single_universe(self):
        ...
        self.assertEqual(
            len(dmx_data), 512,
            msg='Unexpected DMX data buffer size'
        )
    ...
    def test_disconnect(self):
        ...
        self.assertEqual(
            self.wled.sender, None,
            msg='Active senders after stop()'
        )
